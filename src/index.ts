...
async function updateSupportedStatusAsync(feature: string) {
    ...
    document
        ...
        .forEach((el) => {
            ...
            const unsupportedIndicator = getTemplate(
                "#js-unsupported-indicator"
            );
            ...
            el.innerHTML = "";
            el.appendChild(
                supported ? supportedIndicator : unsupportedIndicator
            );
        ...
        getSources: () => [
            {
                ...
                templates: {
                    noResults: ({ state }) => {
                        ...
                        template.querySelector(".js-feature").textContent =
                            state.query;
                        return template;
                    },
                    section: () => {
...
root.addEventListener("click", () => void initializeAutocomplete(), {
    once: true,
});
root.querySelector("input").addEventListener(
    "focus",
